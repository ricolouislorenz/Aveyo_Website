          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
                Während die Inflation dein Geld entwertet,
                <br />
                sorgen wir dafür, dass dein Vermögen für dich arbeitet.
              </p>
            </div>
          </div>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-[#586477] max-w-3xl mx-auto leading-relaxed">
                  Wir glauben nicht an die Glaskugel. Niemand kann die Zukunft
                  vorhersagen – weder wir noch die "Gurus" an der Wall Street.
                  Deshalb basieren unsere Strategien auf Evidenz, nicht auf
                  Spekulation.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-gradient-to-br from-[#172545] to-[#2a3f6f] rounded-3xl p-8 text-white">
                  ...
                  <p className="text-white/80 leading-relaxed">
                    Wir versuchen nicht, den Markt zu schlagen (was langfristig
                    fast niemand schafft), sondern die Marktrendite effizient
                    einzufangen.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-[#172545] to-[#2a3f6f] rounded-3xl p-8 text-white">
                  ...
                  <p className="text-white/80 leading-relaxed">
                    Jeder Euro, den du an Gebühren sparst, ist ein Euro mehr
                    Rendite für dich. Wir nutzen kosteneffiziente Lösungen, um
                    deinen Zinseszinseffekt zu maximieren.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-[#172545] to-[#2a3f6f] rounded-3xl p-8 text-white">
                  ...
                  <p className="text-white/80 leading-relaxed">
                    Die Börse schwankt. Das ist normal. Wir helfen dir, Kurs zu
                    halten und rationale Entscheidungen zu treffen, wenn andere
                    nervös werden.
                  </p>
                </div>
              </div>
  ...
  />
                ...
                <div className="lg:w-1/2 text-white">
                  <p className="text-xl mb-6 text-white/90 italic">
                    Warum die Nadel im Heuhaufen suchen, wenn man einfach den
                    ganzen Heuhaufen kaufen kann?
                  </p>
                  <p className="text-lg mb-6 leading-relaxed text-white/80">
                    Statt auf einzelne Aktien zu wetten, setzen wir auf globale
                    Diversifikation. Mit Indexfonds (ETFs) investierst du in
                    tausende von Unternehmen weltweit – gleichzeitig.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white/70">
                          Du bist nicht abhängig vom Erfolg einer einzelnen Firma
                          oder Region. Geht es einem Unternehmen schlecht,
                          fangen die anderen das auf.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white/70">
                          Dein Geld ist flexibel verfügbar. Kein Festgeld, keine
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white/70">
                          Du weißt immer genau, worin du investiert bist.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-[#586477] max-w-3xl mx-auto leading-relaxed">
                  Für dein Geld wollen wir nur das Beste. Deshalb arbeiten wir
                  strategisch mit Vanguard zusammen, einem der größten und
                  vertrauenswürdigsten Vermögensverwalter der Welt.
                </p>
              </div>

              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-10 md:p-12 mb-12">
                <h3 className="text-3xl text-[#172545] mb-8 font-bold text-center">
                  Warum Vanguard?
                </h3>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="bg-white rounded-2xl p-6 shadow-lg">
                    ...
                    <h4 className="text-xl font-semibold text-[#172545] mb-3">
                      Genossenschaftliche Struktur
                    </h4>
                    <p className="text-[#586477] leading-relaxed">
                      Vanguard gehört den Fondsanlegern selbst. Es gibt keine
                      externen Aktionäre, die Gewinne abschöpfen wollen. Das Ziel
                      ist allein dein Vorteil.
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-lg">
                    ...
                    <p className="text-[#586477] leading-relaxed">
                      Vanguard ist Pionier bei niedrigen Gebühren. Diese
                      Kostenvorteile geben wir direkt an dich weiter.
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-lg">
                    ...
                    <p className="text-[#586477] leading-relaxed">
                      Genau wie wir denkt Vanguard in Jahrzehnten, nicht in
                      Quartalen.
                    </p>
                  </div>
                </div>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
                  Ein ETF-Sparplan allein ist noch keine Strategie. Dein
                  Investment muss zu deinem Leben passen – und zu deinen Risiken.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 leading-relaxed">
                        Wieviel Schwankung hältst du aus (und kannst du dir
                        leisten)? Wir ermitteln dein individuelles Risikoprofil.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 leading-relaxed">
                        Wir mischen risikobehaftete Anlagen (Aktien) und
                        risikoarme Bausteine (Anleihen/Tagesgeld) so, dass sie
                        exakt zu deinen Zielen passen.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 leading-relaxed">
                        Bevor wir den ersten Euro investieren, stellen wir
                        sicher, dass dein Notgroschen steht und deine
                        Existenzrisiken abgesichert sind.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-[#586477] mb-10 leading-relaxed">
                Lass uns deine Strategie bauen. Wissenschaftlich,
                kosteneffizient und genau auf dich zugeschnitten.
              </p>
              <Link
                to="/termin"
